...
\begin{frame}{Objectives}
    \begin{itemize}
        \item Develop an IoT application based on the technologies used so far
...
\begin{frame}{UDP/IP}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                \item System connected to the Local Area Network (LAN)
                \item Members: 
                \begin{itemize}
...
\begin{frame}{Deliverables}
    \begin{itemize}
        ...
        \item Due date: 19/05/2026 (10:30)
        \item PowerPoint presentation 
        \item Oral presentation + Demo Class on 20/06/2025 at 17:30
    \end{itemize}
\end{frame}
